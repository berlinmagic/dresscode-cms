  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def create_themes_folder
        puts("THEME INFO :::::> erstelle Theme-Ordner = [ #{DcStaticthemes.config.themes_path} ]")
        empty_directory(DcStaticthemes.config.themes_path)
      end
      ...
      def create_default_folder
        ...
        empty_directory( File.join( DcStaticthemes.config.themes_path, "default") )
        def_dir = File.join( File.expand_path(DcStaticthemes.config.themes_path), "default", "views" )
      ...
      private
        ...
        def make_modul_theme(modul)
          ...
          Strangecms::FileUtilz.mirror_files( 
                ...
                File.join("#{DcStaticthemes.config.themes_path}", "default", "views") 
                )
          ...
          Strangecms::FileUtilz.mirror_files( 
                ...
                File.join("#{DcStaticthemes.config.themes_path}", 'default')
                )
