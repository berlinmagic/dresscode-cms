...
require 'dc_staticthemes/config'
require 'dc_staticthemes/common_methods'
require 'dc_staticthemes/url_helpers'
require 'dc_staticthemes/view_helpers'
require 'dc_staticthemes/assets_controller'
require 'dc_staticthemes/controller_methods'
require 'dc_staticthemes/railtie'
require 'dc_staticthemes/routes'
require 'dc_staticthemes/gemed_themes'
...
module DcStaticthemes
  class << self
    ...
    def config
      @config ||= DcStaticthemes::Config.new
    ...
    def add_themes_path_to_sass
      if DcStaticthemes.config.sass_is_available?
