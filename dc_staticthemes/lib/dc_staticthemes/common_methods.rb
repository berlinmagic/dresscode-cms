module DcStaticthemes
  ...
  public
    ...
    def theme_path(base = DcStaticthemes.config.base_dir)
      theme_path_for(theme_name, base)
    end
    
    # => def theme_path_for(name, base = DcStaticthemes.config.base_dir, theme_dir = DcStaticthemes.config.themes_dir)
    def theme_path_for(name, base = nil, theme_dir = DcStaticthemes.config.themes_dir)
      base = DcStaticthemes.all_theme_hash[name]['base']
