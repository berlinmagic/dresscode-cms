@DcMercury.tableEditor = (table, cell, cellContent) ->
  DcMercury.tableEditor.load(table, cell, cellContent)
  return DcMercury.tableEditor

jQuery.extend DcMercury.tableEditor,
