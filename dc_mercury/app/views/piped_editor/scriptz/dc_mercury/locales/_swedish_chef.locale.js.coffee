DcMercury.I18n['swedish_chef'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s is unsooppurted in thees cleeent. Sooppurted broosers ere-a %s Bork Bork Bork!"
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor cun oonly be-a instunteeeted oonce-a. Bork Bork Bork!"
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury ves uneble-a tu sefe-a tu zee url: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury ves uneble-a tu lued %s fur zee \"%s\" deeelug."
  "DcMercury was unable to load %s for the lightview.": "DcMercury ves uneble-a tu lued %s fur zee leeghtfioo."
  "DcMercury was unable to load %s for the modal.": "DcMercury ves uneble-a tu lued %s fur zee mudel."
