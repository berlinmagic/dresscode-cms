DcMercury.I18n['sv'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s stöds inte i denna klient. Stödda webbläsare är %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor kan bara ha en instans."
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury kunde inte spara till adressen: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury kunde inte ladda %s för \"%s\" dialogen."
  "DcMercury was unable to load %s for the lightview.": "DcMercury kunde inte ladda %s för lightwiev."
  "DcMercury was unable to load %s for the modal.": "DcMercury kunde inte ladda %s för denna modal."
