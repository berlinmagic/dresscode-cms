DcMercury.I18n['de'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s wird von diesem Client nicht unterstützt. Unterstützte Browser sind: %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor kann nur einmal instanziiert werden."
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury war nicht in der Lage unter der URL zu speichern: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury konnte %s nicht für den \"%s\"-Dialog laden."
  "DcMercury was unable to load %s for the lightview.": "DcMercury konnte %s nicht für die Lightansicht laden."
  "DcMercury was unable to load %s for the modal.": "DcMercury konnte %s nicht für den Modaldialog laden."
