DcMercury.I18n['fr'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s n'est pas supporté dans ce client. Les navigateurs supportés sont %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor ne peut être démarré qu'une fois."
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury n'a pas pu sauvegarder sur l'URL : %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury n'a pas pu charger %s pour la fenêtre \"%s\"."
  "DcMercury was unable to load %s for the lightview.": "DcMercury n'a pas pu charger %s pour l'aperçu."
  "DcMercury was unable to load %s for the modal.": "DcMercury n'a pas pu charger %s pour la modale."
