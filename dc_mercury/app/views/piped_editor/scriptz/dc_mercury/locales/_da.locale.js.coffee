DcMercury.I18n['da'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s er ustøttet i denne klient. Støttede browsere er %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor kan kun blive instantieret én gang."
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury var ikke i stand til at gemme til addressen: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury kunne ikke indlæse %s for \"%s\"dialogen."
  "DcMercury was unable to load %s for the lightview.": "DcMercury kunne ikke indlæse %s for lightview."
  "DcMercury was unable to load %s for the modal.": "DcMercury kunne ikke indlæse %s for denna modal."
