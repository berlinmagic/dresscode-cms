DcMercury.I18n['pt'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s não aceita seu navegador. Utilize um dos seguintes: %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor não pode ser inicializado duas vezes"
  "Opera isn't a fully supported browser, your results may not be optimal.": "DcMercury.PageEditor não é garantido no navegador Opera, seus resultados podem não ser os esperados."
  "DcMercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "DcMercury.PageEditor não pôde carregar: %s\n\nPor favor, recarregue a página."
  ...
  "DcMercury was unable to save to the url: %s": ""
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury não carregou \"%s\" para a janela \"%s\"."
  "DcMercury was unable to load %s for the lightview.": "DcMercury não carregou \"%s\" na lightview."
  "DcMercury was unable to load %s for the modal.": "DcMercury não carregou \"%s\" como modal."
  ...
  # About DcMercury Panel (about.html)
