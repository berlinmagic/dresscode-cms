DcMercury.I18n['nl'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s niet ondersteund voor deze browser. Ondersteunde browsers zijn: %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor kan maar één keer worden gestart."
  ...
  "DcMercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "DcMercury.PageEditor failed to load: %s\n\nPlease try refreshing."
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury was unable to save to the url: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury was unable to load %s for the \"%s\" dialog."
  "DcMercury was unable to load %s for the lightview.": "DcMercury was unable to load %s for the lightview."
  "DcMercury was unable to load %s for the modal.": "DcMercury was unable to load %s for the modal."
