DcMercury.I18n['ko'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s 는 지원하지 않는 클라이언트 입니다. %s 브라우저를 지원합니다."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor는 한 번만 갹채화 될 수 있습니다."
  "Opera isn't a fully supported browser, your results may not be optimal.": "오페라 브라우저에선 모든 기능을 지원하지 않으므로, 결과가 최적화 되어 나타나지 않습니다."
  "DcMercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "DcMercury.PageEditor 가 읽기에 실패했습니다. : %s\n\n새로고침을 해보세요."
  ...
  "DcMercury was unable to save to the url: %s": "머큐리는 그 경로에 저장 할 수 없습니다.: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "머큐리는 %s 를 읽을 수 없는 문제가 \"%s\" 창에서 발생했습니다."
  "DcMercury was unable to load %s for the lightview.": "머큐리는 경량뷰에서 %s를 읽을 수 없습니다."
  "DcMercury was unable to load %s for the modal.": "머큐리는 모달 창에서 %s를 읽을 수 없습니다."
