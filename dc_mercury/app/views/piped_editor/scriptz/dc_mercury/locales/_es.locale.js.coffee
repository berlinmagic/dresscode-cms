DcMercury.I18n['es'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s no está soportado en este cliente. Los navegadores soportados son %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor solo puede ser llamado una vez."
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury no pudo guardar en la url: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury no pudo cargar %s para el diálogo \"%s\"."
  "DcMercury was unable to load %s for the lightview.": "DcMercury no pudo cargar %s para el lightview."
  "DcMercury was unable to load %s for the modal.": "DcMercury no pudo cargar %s para el modal."
