DcMercury.I18n['en'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": ""
  "DcMercury.PageEditor can only be instantiated once.": ""
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": ""
  "DcMercury was unable to load %s for the lightview.": ""
  "DcMercury was unable to load %s for the modal.": ""
