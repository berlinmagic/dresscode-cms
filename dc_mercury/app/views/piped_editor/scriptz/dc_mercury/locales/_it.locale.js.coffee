DcMercury.I18n['it'] =
  ...
  # ### General
  # Error Messages
  "DcMercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcMercury.Regions.%s non è supportato in questo computer. I browser supportati sono %s."
  "DcMercury.PageEditor can only be instantiated once.": "DcMercury.PageEditor può essere istanziato una sola volta."
  ...
  "DcMercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "È fallito il caricamento di DcMercury.PageEditor: %s\n\nProva a ricaricare la pagina."
  ...
  "DcMercury was unable to save to the url: %s": "DcMercury non è stato in grado di salvare l'url: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcMercury was unable to load %s for the \"%s\" dialog.": "DcMercury non è stato in grado di caricare %s per il dialogo \"%s\"."
  "DcMercury was unable to load %s for the lightview.": "DcMercury non è stato in grado di caricare %s per la lightview."
  "DcMercury was unable to load %s for the modal.": "DcMercury non è stato in grado di caricare %s per il dialogo modale."
