module Rack
  ...
  #
  # The Rack::DcStaticCache middleware automatically adds, removes and modifies
  ...
  # the caches. Rack::DcStaticCache by default handles version numbers in the filename.
  # As an example,
  ...
  #
  # You can use Rack::Deflater along with Rack::DcStaticCache for further improvements in page loading time.
  #
  # Examples:
  #     use Rack::DcStaticCache, :urls => ["/images", "/css", "/js", "/documents*"], :root => "statics"
  ...
  #     default headers.
  #
  #     use Rack::DcStaticCache, :urls => ["/images"], :duration => 2, :versioning => false
  ...
  #     (default for :duration is 1 minute), and StaticCache will not compute any versioning logics (default for
  #     :versioning is true)
  #
  ...
  class DcStaticCache
    ...
    def initialize(app, options={})
      ...
      @cache_duration = options[:duration] || 42
