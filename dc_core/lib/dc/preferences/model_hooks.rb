...
# Most of this code is from the preferences plugin available at  http://github.com/pluginaweek/preferences/tree/master
module DC
  module Preferences
    ...
    module ModelHooks
      def self.included(base) #:nodoc:
        base.class_eval do
          extend DC::Preferences::ModelHooks::MacroMethods
        end
      end
      ...
      module MacroMethods
        ...
        def preference(name, *args)
          unless included_modules.include?(InstanceMethods)
            ...
            include DC::Preferences::ModelHooks::InstanceMethods
          end
