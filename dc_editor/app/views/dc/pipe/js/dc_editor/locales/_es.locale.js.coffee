DcEditor.I18n['es'] =
  ...
  # ### General
  # Error Messages
  "DcEditor.PageEditor is unsupported in this client. Supported browsers are Chrome 10+, Firefox 4+, and Safari 5+.": "DcEditor.PageEditor no está soportado en este cliente. Los navegadores soportados son Chrome 10+, Firefox 4+, y Safari 5+."
  "DcEditor.PageEditor can only be instantiated once.": "DcEditor.PageEditor solo puede ser llamado una vez."
  ...
  "DcEditor was unable to save to the url: %s": "DcEditor no pudo guardar en la url: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcEditor was unable to load %s for the \"%s\" dialog.": "DcEditor no pudo cargar %s para el diálogo \"%s\"."
  "DcEditor was unable to load %s for the lightview.": "DcEditor no pudo cargar %s para el lightview."
  "DcEditor was unable to load %s for the modal.": "DcEditor no pudo cargar %s para el modal."
