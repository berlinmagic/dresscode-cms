DcEditor.I18n['swedish_chef'] =
  ...
  # ### General
  # Error Messages
  "DcEditor.PageEditor is unsupported in this client. Supported browsers are Chrome 10+, Firefox 4+, and Safari 5+.": "DcEditor.PageEditor is unsooppurted in thees cleeent. Sooppurted broosers ere-a Chrome 10+, Firefox 4+, und Safari 5+. Bork Bork Bork!"
  "DcEditor.PageEditor can only be instantiated once.": "DcEditor.PageEditor cun oonly be-a instunteeeted oonce-a. Bork Bork Bork!"
  ...
  "DcEditor was unable to save to the url: %s": "DcEditor ves uneble-a tu sefe-a tu zee url: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcEditor was unable to load %s for the \"%s\" dialog.": "DcEditor ves uneble-a tu lued %s fur zee \"%s\" deeelug."
  "DcEditor was unable to load %s for the lightview.": "DcEditor ves uneble-a tu lued %s fur zee leeghtfioo."
  "DcEditor was unable to load %s for the modal.": "DcEditor ves uneble-a tu lued %s fur zee mudel."
  ...
  # About DcEditor Panel (about.html)
