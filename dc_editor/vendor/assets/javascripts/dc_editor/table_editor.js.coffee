@DcEditor.tableEditor = (table, cell, cellContent) ->
  DcEditor.tableEditor.load(table, cell, cellContent)
  return DcEditor.tableEditor

jQuery.extend DcEditor.tableEditor,
