DcEditor.I18n['fr'] =
  ...
  # ### General
  # Error Messages
  "DcEditor.PageEditor is unsupported in this client. Supported browsers are Chrome 10+, Firefox 4+, and Safari 5+.": "DcEditor.PageEditor n'est pas supporté dans ce client. Les navigateurs supportés sont Chrome 10+, Firefox 4+ et Safari 5+."
  "DcEditor.PageEditor can only be instantiated once.": "DcEditor.PageEditor ne peut être démarré qu'une fois."
  ...
  "DcEditor was unable to save to the url: %s": "DcEditor n'a pas pu sauvegarder sur l'URL : %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcEditor was unable to load %s for the \"%s\" dialog.": "DcEditor n'a pas pu charger %s pour la fenêtre \"%s\"."
  "DcEditor was unable to load %s for the lightview.": "DcEditor n'a pas pu charger %s pour l'aperçu."
  "DcEditor was unable to load %s for the modal.": "DcEditor n'a pas pu charger %s pour la modale."
