DcEditor.I18n['de'] =
  ...
  # ### General
  # Error Messages
  "DcEditor.Regions.%s is unsupported in this client. Supported browsers are %s.": "DcEditor.Regions.%s wird von diesem Client nicht unterstützt. Unterstützte Browser sind: %s."
  "DcEditor.PageEditor can only be instantiated once.": "DcEditor.PageEditor kann nur einmal instanziiert werden."
  ...
  "DcEditor was unable to save to the url: %s": "DcEditor war nicht in der Lage unter der URL zu speichern: %s"
  # Confirmations
  ...
  # ### Modals / Dialogs / Etc.
  # Error Messages
  "DcEditor was unable to load %s for the \"%s\" dialog.": "DcEditor konnte %s nicht für den \"%s\"-Dialog laden."
  "DcEditor was unable to load %s for the lightview.": "DcEditor konnte %s nicht für die Lightansicht laden."
  "DcEditor was unable to load %s for the modal.": "DcEditor konnte %s nicht für den Modaldialog laden."
