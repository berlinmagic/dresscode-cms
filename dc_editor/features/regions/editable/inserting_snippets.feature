...
Feature:
  ...
  Scenario: A user can drag and drop snippets into an editable region
    ...
    And the contents of the editable region should be "this is <div data-version='1' data-snippet='snippet_14' class='dc_editor-snippet' contenteditable='false'><strong>Jeremy</strong> likes Stella</div><span>simple</span> <b>content</b>"
  ...
  Scenario: A user can use the snippet toolbar to edit the options of a snippet
    ...
    And fill in "Favorite Beer" with "Stella"
    And press "Insert Snippet"
    Then the contents of the editable region should be "<div data-version='2' data-snippet='snippet_42' class='dc_editor-snippet' contenteditable='false'><strong>Jeremy</strong> likes Stella</div> <b>content</b>"
  ...
  Scenario: A user can make changes to a snippets options, and they'll be versioned for undo and redo
    ...
    And press "Insert Snippet"
    Then the content of the editable region should be "<div data-version='3' data-snippet='snippet_42' class='dc_editor-snippet' contenteditable='false'><strong>Diesel</strong> likes Bells Hopslam</div> <b>content</b>"
...
#    And the "Favorite Beer" field should contain "Stella"
    ...
    Then the contents of the editable region should be "<div data-version='3' data-snippet='snippet_42' class='dc_editor-snippet' contenteditable='false'><strong>Diesel</strong> likes Bells Hopslam</div> <b>content</b>"
    ...
    And press "Insert Snippet"
    Then the contents of the editable region should be "<div data-version='4' data-snippet='snippet_42' class='dc_editor-snippet' contenteditable='false'><strong>Jen</strong> likes Miller High Life</div> <b>content</b>"
