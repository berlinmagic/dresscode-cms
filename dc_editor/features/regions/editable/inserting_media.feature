...
#  Scenario: A user can insert and edit an image
    ...
    When I fill in "URL" with "/assets/dc_editor/temp-logo.png"
    And press "Insert Media"
    Then the contents of the editable region should be "this is <img src='/assets/dc_editor/temp-logo.png'> <b>content</b>"
    And the modal window should not be visible

    When I make a selection for "img"
    And click on the "Insert Media" button
    Then the "media_image_url" field should contain "/assets/dc_editor/temp-logo.png"

    When I fill in "URL" with "/assets/dc_editor/default-snippet.png"
    And press "Insert Media"
    Then the contents of the editable region should be "this is <img src='/assets/dc_editor/default-snippet.png'> <b>content</b>"
...
#  Scenario: A user can insert and edit an image with an alignment set
    ...
    When I click on the "Insert Media" button
    When I fill in "media_image_url" with "/assets/dc_editor/temp-logo.png"
    And select "Right" from "Alignment"
    And press "Insert Media"
    Then the contents of the editable region should be "this is <img src='/assets/dc_editor/temp-logo.png' align='right'> <b>content</b>"

    When I make a selection for "img"
    And click on the "Insert Media" button
    And select "Absolute Middle" from "Alignment"
    And press "Insert Media"
    Then the contents of the editable region should be "this is <img src='/assets/dc_editor/temp-logo.png' align='absmiddle'> <b>content</b>"
  ...
  Scenario: A user can edit an image by double clicking it
    ...
    Then the modal window should be visible
    And I should see "Insert Media (images and videos)" within the modal title
    And the "media_image_url" field should contain "/assets/dc_editor/temp-logo.png"

    When I fill in "URL" with "/assets/dc_editor/default-snippet.png"
    And select "Absolute Middle" from "Alignment"
    And press "Insert Media"
    Then the contents of the editable region should be "this is <img src='/assets/dc_editor/default-snippet.png' align='absmiddle'> <b>content</b>"
