module DcEditorContentsHelpers
  def contents_for(name)
    case name
      ...
      when 'an image' then "this is <img src='/assets/dc_editor/temp-logo.png'> <b>content</b>"
      ...
      when 'the snippet', 'that snippet' then "<div class='dc_editor-snippet' data-snippet='#{@snippet_id || 'snippet_42'}'>#{@snippet_id || 'snippet_42'}</div> <b>content</b>"
