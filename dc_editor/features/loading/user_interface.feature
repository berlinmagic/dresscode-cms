...
#  Scenario: A user can view and close the about dialog
    ...
    Then I should see "DcEditor Editor" within the lightview title
    And I should see "DcEditor Editor is an open source HTML5 WYSIWYG editor written in Coffeescript using jQuery. The project has been released under the MIT license." within the lightview window
