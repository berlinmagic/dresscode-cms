describe "DcEditor.HistoryBuffer", ->

  beforeEach ->
    @buffer = new DcEditor.HistoryBuffer(5)
  ...
  describe "#push", ->
    ...
    it "won't duplicate items if the content is the same", ->
      ...
      @buffer.push('2<em class="dc_editor-marker"></em>')
      expect(@buffer.stack).toEqual(['1', '2<em class="dc_editor-marker"></em>'])
