describe "DcEditor.modalHandlers.insertTable", ->

  template 'dc_editor/modals/inserttable.html'
  ...
  describe "initializing", ->
    ...
    beforeEach ->
      @tableEditorSpy = spyOn(DcEditor, 'tableEditor').andCallFake(=>)
      DcEditor.modalHandlers.insertTable.call(@modal)
  ...
  describe "clicking on the action buttons", ->
    ...
    beforeEach ->
      @addRowSpy = spyOn(DcEditor.tableEditor, 'addRow').andCallFake(=>)
      @removeRowSpy = spyOn(DcEditor.tableEditor, 'removeRow').andCallFake(=>)
      @addColumnSpy = spyOn(DcEditor.tableEditor, 'addColumn').andCallFake(=>)
      @removeColumnSpy = spyOn(DcEditor.tableEditor, 'removeColumn').andCallFake(=>)
      @increaseColspanSpy = spyOn(DcEditor.tableEditor, 'increaseColspan').andCallFake(=>)
      @decreaseColspanSpy = spyOn(DcEditor.tableEditor, 'decreaseColspan').andCallFake(=>)
      @increaseRowspanSpy = spyOn(DcEditor.tableEditor, 'increaseRowspan').andCallFake(=>)
      @decreaseRowspanSpy = spyOn(DcEditor.tableEditor, 'decreaseRowspan').andCallFake(=>)
      DcEditor.modalHandlers.insertTable.call(@modal)
