describe "DcEditor.modalHandlers.insertMedia", ->

  template 'dc_editor/modals/insertmedia.html'
  ...
  describe "clicking on a radio button (in a label)", ->
    ...
    beforeEach ->
      DcEditor.modalHandlers.insertMedia.call(@modal)
  ...
  describe "when editing", ->
    ...
    describe "an existing image", ->
      ...
      beforeEach ->
        ...
        DcEditor.region = selection: => @selection
        DcEditor.modalHandlers.insertMedia.call(@modal)
