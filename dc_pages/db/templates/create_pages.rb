class CreatePages < ActiveRecord::Migration
  ...
  def up
    create_table :pages do |t|
      ...
      t.string        :page_type,         :default => 'page'        # => page | module | mixed  ... content editable ?
      
      t.boolean       :system_page,       :default => false         # => Page is needed by the cms and can't be deleted
      ...
      t.references    :tlayout                                      # => which (dynamic) layout 
      ...
      t.boolean       :show_breadcrumbs,  :default => false         # => Breadcrumps auf der Seite anzeigen ? 
